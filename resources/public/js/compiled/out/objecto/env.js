...
})], null),new cljs.core.Keyword(null,"String","String",584378334),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.Keyword(null,"ident","ident",-742346),(2),new cljs.core.Keyword(null,"double","double",884886883),(function (x,_,___$1){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),cljs.core.str.cljs$core$IFn$_invoke$arity$1(x)].join('');
}),new cljs.core.Keyword(null,"index","index",-1531685915),(function (self,params,env){
return clojure.string.index_of.call(null,self,cljs.core.get.call(null,params,new cljs.core.Keyword(null,"index","index",-1531685915)));
})], null),new cljs.core.Keyword(null,"Number","Number",2146289584),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"double","double",884886883),(function (x,_,___$1){
return (x * (2));
}),new cljs.core.Keyword(null,"abs","abs",-246026477),(function (x,_,___$1){
return Math.abs(x);
}),new cljs.core.Keyword(null,"ident","ident",-742346),(3),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.Keyword(null,"add","add",235287739),(function (x,params,_){
...
//# sourceMappingURL=env.js.map?rel=1576362104464
