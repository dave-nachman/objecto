...
var G__26701 = (root.arr[(slc - (1))]);
var G__26702 = (shift - (5));
var G__26703 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__26701;
shift = G__26702;
cnt = G__26703;
continue;
...
if((!(r_QMARK_))){
var rngs_26712 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_26713 = (rngs_26712[(0)]);
var new_rngs_26714 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_26715 = (rngs_26712[(32)]);
cljs.core.array_copy.call(null,rngs_26712,(1),new_rngs_26714,(0),(lim_26715 - (1)));

var i_26716 = (0);
while(true){
if((i_26716 < lim_26715)){
(new_rngs_26714[i_26716] = ((new_rngs_26714[i_26716]) - rng0_26713));
...
(new_rngs_26714[(32)] = ((rngs_26712[(32)]) - (1)));

(new_rngs_26714[((rngs_26712[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_26714);
} else {
}
...
while(true){
if((i_26718 <= li)){
(new_rngs[i_26718] = ((new_rngs[(i_26718 - (1))]) + step));
...
while(true){
if((i_26720 <= li)){
(new_rngs[i_26720] = ((rngs[i_26720]) - d));
...
while(true){
if((j_26722 <= i)){
(rngs[j_26722] = r_26723);

var G__26724 = (j_26722 + (1));
var G__26725 = (r_26723 + step);
j_26722 = G__26724;
r_26723 = G__26725;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__26726 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__26726[(0)] = node.arr.length);
...
var arr_26727__$1 = arr;
var shift_26728__$1 = shift;
while(true){
if((shift_26728__$1 === (5))){
if((!(reg_QMARK_))){
(arr_26727__$1[(32)] = rngs);
} else {
}

(arr_26727__$1[(0)] = node);
} else {
var a_26729 = (new Array(len));
var e_26730 = cljs.core.__GT_VectorNode.call(null,null,a_26729);
(arr_26727__$1[(0)] = e_26730);
...
var G__26731 = a_26729;
var G__26732 = (shift_26728__$1 - (5));
arr_26727__$1 = G__26731;
shift_26728__$1 = G__26732;
continue;
}
break;
}
