...
var G__26086 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26086;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26087 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26087,ch);
...
if(("\\" === ch__$1)){
var ch_26088__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26088__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26088__$2);
} else {
}

var G__26089 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26089;
continue;
}
}
...
var vec__26097 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26097,(0),null);
var start_column = cljs.core.nth.call(null,vec__26097,(1),null);
...
var G__26100 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26100;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26101 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26102 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26102;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26101;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26103 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26103,(0),null);
var start_column = cljs.core.nth.call(null,vec__26103,(1),null);
...
var vec__26106 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26106,(0),null);
var end_column = cljs.core.nth.call(null,vec__26106,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__26109,(0),null);
var start_column = cljs.core.nth.call(null,vec__26109,(1),null);
...
var vec__26112 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26112,(0),null);
var end_column = cljs.core.nth.call(null,vec__26112,(1),null);
...
var vec__26115 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26115,(0),null);
var start_column = cljs.core.nth.call(null,vec__26115,(1),null);
...
var vec__26118 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26118,(0),null);
var end_column = cljs.core.nth.call(null,vec__26118,(1),null);
...
var sb = (function (){var G__26121 = (new goog.string.StringBuffer());
G__26121.append(initch);
...
var G__26123 = (function (){var G__26122 = sb;
G__26122.append(ch);

return G__26122;
})();
var G__26124 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26123;
ch = G__26124;
continue;
}
...
switch (G__26127) {
case "\\":
var G__26131 = (function (){var G__26128 = sb;
G__26128.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26128;
})();
var G__26132 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26131;
ch = G__26132;
continue;
...
break;
default:
var G__26133 = (function (){var G__26129 = sb;
G__26129.append(ch);

return G__26129;
})();
var G__26134 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26133;
ch = G__26134;
continue;
...
var vec__26135 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26135,(0),null);
var end_column = cljs.core.nth.call(null,vec__26135,(1),null);
...
var vec__26138 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26138,(0),null);
var column = cljs.core.nth.call(null,vec__26138,(1),null);
...
var vec__26143 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26143,(0),null);
var column = cljs.core.nth.call(null,vec__26143,(1),null);
...
var vec__26148 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26148,(0),null);
var column = cljs.core.nth.call(null,vec__26148,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26153 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26153,(0),null);
var start_column = cljs.core.nth.call(null,vec__26153,(1),null);
...
var vec__26156 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26156,(0),null);
var end_column = cljs.core.nth.call(null,vec__26156,(1),null);
...
var G__26159 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26159,true,null,opts,pending_forms);
...
var G__26160 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26160)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26160)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26160)){
...
var _STAR_suppress_read_STAR__orig_val__26161 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26162 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26162;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26161;
}});
...
var G__26163 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26163,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26163,rdr,first_line);
...
var G__26167 = matched;
var G__26168 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26167;
finished = G__26168;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26169 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26170 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26170;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26169;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26171 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26172 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__26172;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26173 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26173,"(");
...
var G__26174 = (i + (1));
var G__26175 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__26171;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26176 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26176);
...
var G__26177 = cljs.core.next.call(null,s__$1);
var G__26178 = ret;
s__$1 = G__26177;
r = G__26178;
continue;
...
var G__26179 = cljs.core.next.call(null,s);
var G__26180 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26179;
key_vals = G__26180;
continue;
} else {
...
var gensym_env_orig_val__26184 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26185 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__26185;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__26184;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26186 = token;
var G__26186__$1 = (((G__26186 == null))?null:cljs.core.subs.call(null,G__26186,(1)));
var G__26186__$2 = (((G__26186__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26186__$1));
var G__26186__$3 = (((G__26186__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26186__$2));
var G__26186__$4 = (((G__26186__$3 == null))?null:cljs.core.symbol.call(null,G__26186__$3));
if((G__26186__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26186__$4);
}
})():(function (){var G__26187 = token;
var G__26187__$1 = (((G__26187 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26187));
if((G__26187__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26187__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e26194){if((e26194 instanceof Error)){
var e = e26194;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26198,reader){
...
var eof = cljs.core.get.call(null,map__26199__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26205){
var G__26206 = cljs.core.first.call(null,seq26205);
var seq26205__$1 = cljs.core.next.call(null,seq26205);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26206,seq26205__$1);
});
