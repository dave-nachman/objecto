...
var G__28490 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__28490,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__28490;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq28492){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28493,G__28494,seq28492__$2);
});
...
var line = cljs.core.get.call(null,map__28499__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28499__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__28499,map__28499__$1,file,line,column){
return (function (p1__28498_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__28498_SHARP_));
});})(map__28499,map__28499__$1,file,line,column))
...
var temp__5720__auto___28501 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___28501)){
var message_28502 = temp__5720__auto___28501;
cljs.core.println.call(null,message_28502);
} else {
}
...
var temp__5720__auto___28503 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___28503)){
var message_28504 = temp__5720__auto___28503;
cljs.core.println.call(null,message_28504);
} else {
}
...
var output_dir = "resources/public/js/test/out";
var output_dir__$1 = (function (){var G__28505 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__28505,"/"].join('');
} else {
return G__28505;
}
})();
...
var G__28507 = exception.stack;
var G__28507__$1 = (((G__28507 == null))?null:clojure.string.split_lines.call(null,G__28507));
var G__28507__$2 = (((G__28507__$1 == null))?null:cljs.core.get.call(null,G__28507__$1,depth));
if((G__28507__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__28507__$2);
}
} else {
...
var vec__28508 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__28508,(0),null);
var column = cljs.core.nth.call(null,vec__28508,(1),null);
var vec__28511 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__28511,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__28511,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__28511,(2),null);
...
var m__$1 = (function (){var G__28514 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__28518 = (function (){var G__28517 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__28517);
} else {
return G__28517;
}
})();
...
return cljs.core.vary_meta.call(null,G__28519,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__28523 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__28523,(0),null);
var types = vec__28523;
...
return cljs.core.map.call(null,(function (p__28526){
var vec__28527 = p__28526;
var ns = cljs.core.nth.call(null,vec__28527,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__28527,(1),null);
return ((function (vec__28527,ns,vars__$1){
return (function (){
...
var G__28530 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1){
return (function (){
var seq__28531 = cljs.core.seq.call(null,vars__$1);
var chunk__28532 = null;
var count__28533 = (0);
var i__28534 = (0);
while(true){
if((i__28534 < count__28533)){
var v = cljs.core._nth.call(null,chunk__28532,i__28534);
var temp__5720__auto___28536 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___28536)){
var t_28537 = temp__5720__auto___28536;
each_fixture_fn.call(null,((function (seq__28531,chunk__28532,count__28533,i__28534,t_28537,temp__5720__auto___28536,v,each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28537)));
});})(seq__28531,chunk__28532,count__28533,i__28534,t_28537,temp__5720__auto___28536,v,each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1))
);
} else {
}


var G__28538 = seq__28531;
var G__28539 = chunk__28532;
var G__28540 = count__28533;
var G__28541 = (i__28534 + (1));
seq__28531 = G__28538;
chunk__28532 = G__28539;
count__28533 = G__28540;
i__28534 = G__28541;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__28531);
if(temp__5720__auto__){
var seq__28531__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__28531__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__28531__$1);
var G__28542 = cljs.core.chunk_rest.call(null,seq__28531__$1);
var G__28543 = c__4550__auto__;
var G__28544 = cljs.core.count.call(null,c__4550__auto__);
var G__28545 = (0);
seq__28531 = G__28542;
chunk__28532 = G__28543;
count__28533 = G__28544;
i__28534 = G__28545;
continue;
} else {
var v = cljs.core.first.call(null,seq__28531__$1);
var temp__5720__auto___28546__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___28546__$1)){
var t_28547 = temp__5720__auto___28546__$1;
each_fixture_fn.call(null,((function (seq__28531,chunk__28532,count__28533,i__28534,t_28547,temp__5720__auto___28546__$1,v,seq__28531__$1,temp__5720__auto__,each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28547)));
});})(seq__28531,chunk__28532,count__28533,i__28534,t_28547,temp__5720__auto___28546__$1,v,seq__28531__$1,temp__5720__auto__,each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1))
);
} else {
}


var G__28548 = cljs.core.next.call(null,seq__28531__$1);
var G__28549 = null;
var G__28550 = (0);
var G__28551 = (0);
seq__28531 = G__28548;
chunk__28532 = G__28549;
count__28533 = G__28550;
i__28534 = G__28551;
continue;
}
} else {
...
});})(each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1))
);
});})(each_fixture_fn,G__28530,G__28530__$1,env,once_fixtures,each_fixtures,vec__28527,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28530__$1)].join('')));

}
})());
});
;})(vec__28527,ns,vars__$1))
