...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"text","text",-1790561697),(function (p__28558){
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"pass","pass",1574159993),(function (p__28562){
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"escaped","escaped",-1007929769),(function (p__28566){
var vec__28567 = p__28566;
var _ = cljs.core.nth.call(null,vec__28567,(0),null);
var text = cljs.core.nth.call(null,vec__28567,(1),null);
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"span","span",1394872991),(function (p__28570){
...
var _ = first__28573;
var children = seq__28572__$1;
return fipp.engine.serialize.call(null,children);
}));
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"line","line",212345235),(function (p__28574){
var vec__28575 = p__28574;
var _ = cljs.core.nth.call(null,vec__28575,(0),null);
var inline = cljs.core.nth.call(null,vec__28575,(1),null);
var terminate = cljs.core.nth.call(null,vec__28575,(2),null);
...
var G__28578__delegate = function (_){
...
while (G__28579__i < G__28579__a.length) {G__28579__a[G__28579__i] = arguments[G__28579__i + 0]; ++G__28579__i;}
  _ = new cljs.core.IndexedSeq(G__28579__a,0,null);
} 
return G__28578__delegate.call(this,_);};
G__28578.cljs$lang$maxFixedArity = 0;
G__28578.cljs$lang$applyTo = (function (arglist__28580){
var _ = cljs.core.seq(arglist__28580);
return G__28578__delegate(_);
});
G__28578.cljs$core$IFn$_invoke$arity$variadic = G__28578__delegate;
return G__28578;
})()
);
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"group","group",582596132),(function (p__28581){
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"nest","nest",-314993663),(function (p__28585){
var vec__28586 = p__28585;
var seq__28587 = cljs.core.seq.call(null,vec__28586);
var first__28588 = cljs.core.first.call(null,seq__28587);
var seq__28587__$1 = cljs.core.next.call(null,seq__28587);
var _ = first__28588;
var args = seq__28587__$1;
var vec__28589 = ((typeof cljs.core.first.call(null,args) === 'number')?args:cljs.core.cons.call(null,(2),args));
...
var offset = first__28591;
var children = seq__28590__$1;
...
cljs.core._add_method.call(null,fipp.engine.serialize_node,new cljs.core.Keyword(null,"align","align",1964212802),(function (p__28592){
...
var _ = first__28595;
var args = seq__28594__$1;
var vec__28596 = ((typeof cljs.core.first.call(null,args) === 'number')?args:cljs.core.cons.call(null,(0),args));
...
var offset = first__28598;
var children = seq__28597__$1;
...
return (function() {
var G__28600 = null;
var G__28600__0 = (function (){
return rf.call(null);
});
var G__28600__1 = (function (res){
return rf.call(null,res);
});
var G__28600__2 = (function (res,node){
var delta = (function (){var G__28599 = new cljs.core.Keyword(null,"op","op",-1882987955).cljs$core$IFn$_invoke$arity$1(node);
...
G__28600 = function(res,node){
switch(arguments.length){
case 0:
return G__28600__0.call(this);
case 1:
return G__28600__1.call(this,res);
case 2:
return G__28600__2.call(this,res,node);
}
...
/** @this {Function} */
fipp.engine.update_right.cljs$lang$applyTo = (function (seq28602){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28603,G__28604,seq28602__$2);
});
 ...
 */
fipp.engine.annotate_begins = (function fipp$engine$annotate_begins(p__28608){
...
var options = map__28609__$1;
var width = cljs.core.get.call(null,map__28609__$1,new cljs.core.Keyword(null,"width","width",-384071477));
return ((function (map__28609,map__28609__$1,options,width){
return (function (rf){
var pos = cljs.core.volatile_BANG_.call(null,(0));
var bufs = cljs.core.volatile_BANG_.call(null,fipp.deque.empty);
return ((function (pos,bufs,map__28609,map__28609__$1,options,width){
return (function() {
var G__28614 = null;
var G__28614__0 = (function (){
return rf.call(null);
});
var G__28614__1 = (function (res){
return rf.call(null,res);
});
var G__28614__2 = (function (res,p__28611){
...
var node = map__28612__$1;
var op = cljs.core.get.call(null,map__28612__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var right = cljs.core.get.call(null,map__28612__$1,new cljs.core.Keyword(null,"right","right",-452581833));
...
var G__28615 = buffers_STAR__STAR_;
var G__28616 = res_STAR___$1;
buffers_STAR_ = G__28615;
res__$1 = G__28616;
continue;
}
}
...
G__28614 = function(res,p__28611){
switch(arguments.length){
case 0:
return G__28614__0.call(this);
case 1:
return G__28614__1.call(this,res);
case 2:
return G__28614__2.call(this,res,p__28611);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;})(pos,bufs,map__28609,map__28609__$1,options,width))
});
;})(map__28609,map__28609__$1,options,width))
});
/**
 * Given printing options, returns a transducer which produces the fully
 *   laid-out strings.
 */
fipp.engine.format_nodes = (function fipp$engine$format_nodes(p__28617){
...
var width = cljs.core.get.call(null,map__28618__$1,new cljs.core.Keyword(null,"width","width",-384071477));
return ((function (map__28618,map__28618__$1,options,width){
return (function (rf){
...
return ((function (fits,length,tab_stops,column,map__28618,map__28618__$1,options,width){
return (function() {
var G__28624 = null;
var G__28624__0 = (function (){
return rf.call(null);
});
var G__28624__1 = (function (res){
return rf.call(null,res);
});
var G__28624__2 = (function (res,p__28620){
...
var node = map__28621__$1;
var op = cljs.core.get.call(null,map__28621__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var right = cljs.core.get.call(null,map__28621__$1,new cljs.core.Keyword(null,"right","right",-452581833));
...
G__28624 = function(res,p__28620){
switch(arguments.length){
case 0:
return G__28624__0.call(this);
case 1:
return G__28624__1.call(this,res);
case 2:
return G__28624__2.call(this,res,p__28620);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;})(fits,length,tab_stops,column,map__28618,map__28618__$1,options,width))
});
;})(map__28618,map__28618__$1,options,width))
});
fipp.engine.pprint_document = (function fipp$engine$pprint_document(document,options){
var options_28626__$1 = cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),(70)], null),options);
cljs.core.run_BANG_.call(null,cljs.core.print,cljs.core.eduction.call(null,fipp.engine.annotate_rights,fipp.engine.annotate_begins.call(null,options_28626__$1),fipp.engine.format_nodes.call(null,options_28626__$1),fipp.engine.serialize.call(null,document)));
